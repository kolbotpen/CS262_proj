                ...
                <div class="row bg-gray p-4 rounded" style="background: rgba(0, 0, 0, 0.5);">
                    ...
                    <div class="d-flex flex-wrap gap-4 justify-content-center">
                        ...
                        <div class="col-md-5 bg-gray pt-4 pe-4 pb-4 ps-4 rounded" style="border: #383838 1px solid;">
                            ...
                            <p class="section2-description text-gray" style="font-size: 16px;">Use regular sign up provided by our service</p>
                            <div class="contact-input rounded p-4" style="border: #383838 1px solid;">
                                <form action="" method="post">
                                    ...
                                    <div class="mb-3">
                                        <label for="username" class="form-label"><img class="icon" src="assets/images/icon-user.svg" draggable="false"> Username</label>
                                        <input type="text" class="form-control bg-black text-white border-0" id="username" name="username" placeholder="johndoe" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="password-confirm" class="form-label"><img class="icon" src="assets/images/icon-password-confirm.svg" draggable="false"> Confirm Password</label>
                                        <input type="password" class="form-control bg-black text-white border-0" id="password-confirm" name="password-confirm" placeholder="••••••••" required>
                                    </div>
                                    <div class="d-flex justify-content-center">
                                        <button type="submit" class="button-green-gradient">Sign up <img src="assets/images/arrow-right.svg" style="width:8px; margin-left:10px;"></button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5 rounded">
                            ...
                            <div class="col-md-12 bg-gray pt-4 pe-4 pb-4 ps-4 w-100 rounded" style="border: #383838 1px solid;">
                                ...
                                <p class="section2-description text-gray" style="font-size: 16px;">Use third-party accounts to sign up</p>
                                <div class="contact-input rounded p-4" style="border: #383838 1px solid;">
                            ...
                            <div class="col-md-12 bg-gray mt-4 pt-3 pe-4 pb-1 ps-4 rounded" style="border: #383838 1px solid;">
                                <p class="section2-description text-gray" style="font-size: 16px;">Already have an account? <a href="login" class="text-green" style="font-size: 16px;">Login here</a></p>
                            </div>
                        </div>
