...
<div class="container">
  ...
  <div class="container bg-transparent p-0 mb-4 rounded container-border">
    ...
    <div class="profile-section" style="width: 80%; display: flex; flex-direction: column; align-items: center;">
        ...
        @endif
        <div class="profile-content d-flex flex-wrap" style="width: 100%; gap: 20px;">

            <!-- LEFT | Profile Picture Section -->
            <div class="contact-input rounded p-4 text-center profile-box" style="width: 100%;">
                <div class="rounded-circle mb-3 mx-auto" style="width: 200px;">
                    <img src="{{ asset('assets/images/avatar.png') }}" alt="Profile Picture" class="rounded-circle" style="width: 100%;">
                </div>
                <button type="button" class="button-green-gradient" style="width: 100%;">Save Photo
                    <img src="{{ asset('assets/images/arrow-right.svg') }}" style="width: 8px; margin-left: 10px;">
                </button>
            </div>

            <!-- MIDDLE | Profile Edit Form -->
            <div class="contact-input rounded p-4 profile-box" style="width: 100%;">
                <form method="POST" action="{{ route('profile.update') }}">
                    ...
                    <div class="d-flex justify-content-center mt-3">
                        <button type="submit" class="button-green-gradient" style="width: 100%;">Save Changes
                            <img src="{{ asset('assets/images/arrow-right.svg') }}" style="width: 8px; margin-left: 10px;">
                        </button>
                    </div>
                </form>
            ...
            <div class="contact-input rounded p-4 profile-box" style="width: 100%;">
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="d-flex justify-content-center mt-3">
                        <button type="submit" class="button-green-gradient" style="width: 100%;">Update
                            <img src="{{ asset('assets/images/arrow-right.svg') }}" style="width: 8px; margin-left: 10px;">
                        </button>
                    </div>
                </form>
